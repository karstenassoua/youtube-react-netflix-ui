...
"
          ...
          <ListItem
            ...
            duration="S9:E27: Signing of Tripartite Pact"
            year="1940"
            desc="
...
"
          ...
          <ListItem
            ...
            year="1941"
            desc="A struggling Russia football team is in need of serious offensive line help, especially on their Eastern Side. We follow a homeless high school aged Russian: Khalkin-Gol Oher, as he is adopted by Stalin Bullock and her family. He is put into the local public school, and immediately takes up football. Khalkhin-Gol immediately improves the offensive line, playing Eastern tackle for the team. They make it all the way to the International Championship, where they face Japan at the heavily contested Mongolia-Manchuria border. Japanese defensive rush after Japanese defensive rush, Khalkin-Gol Oher stays tall. Unfortunately, even though it was the International championship, after many overtimes, the two teams decided to call it even. They signed the infamous Japanese-Soviet Football Neutrality Pact. The Russian football team could now relax because their Eastern part of their offensive line was set by Khalkin-Gol, now their biggest concern was the Western part of their offensive line. Their biggest threat to the Western part of their line was the German D-line man Adolf Bosa. The Japanese Football team also realigned conferences, and now played in the Indo-China division of High School football, which would lead to the Japanese football and American football squads facing off in the postseason, famously named The Attack on the Pearl Harbor Gridiron."
          />
          <ListItem
            index={5}
            trailer="https://player.vimeo.com/video/195276636?h=3d3dc211e0&title=0&byline=0&portrait=0"
